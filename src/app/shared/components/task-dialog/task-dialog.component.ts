...
export class TaskDialogComponent implements  OnChanges  {
  ...
  constructor(public tasksService: TaskService, private gDService:GDService){}
  ...
  restore(){
    this.gDService.openConfirmDialog('THIS VERSION WILL REPLACE THE CURRENT ONE', 'Are you sure?').subscribe((res) => {
      if(res){
