...
@Component({
    ...
    template: `
         <app-task-dialog-edition-and-creation [selectedProject]="selectedProject" [projectParticipants]="projectParticipants" (postTask)="postTask($event)" (putTask)="putTask($event)" [task]="taskSelected" (close)="closeDialog()" [prevDialog]="prevDialog" (dialogBack)="dialogBack()"> </app-task-dialog-edition-and-creation>
    `,
})
